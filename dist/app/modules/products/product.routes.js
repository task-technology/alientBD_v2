...
router.patch('/:id', (0, validateRequest_1.default)(product_validation_1.ProductValidation.update), product_controlller_1.ProductController.updateOneInDB);
router.delete('/:id', product_controlller_1.ProductController.deleteByIdFromDB);
