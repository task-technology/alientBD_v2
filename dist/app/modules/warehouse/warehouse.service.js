...
const getAllFromDB = (filters, options) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (searchTerm) {
        andConditons.push({
            OR: warehouse_constants_1.warehouseSearchableFields.map(field => ({
                [field]: {
                    contains: searchTerm,
                    mode: 'insensitive',
                },
    ...
    const total = yield prisma_1.default.warehouse.count({
        where: whereConditons,
    });
    return {
        meta: {
...
const deleteByIdFromDB = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield prisma_1.default.warehouse.delete({
        where: {
            id: parseInt(id),
        },
    });
